<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php endif; ?>
        <a href="<?= base_url('admin/carreras/crear') ?>" class="btn btn-sm btn-primary shadow-sm px-3 rounded-pill">
    ...
    <div class="card shadow mb-4 border-0">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 d-flex justify-content-end mt-3 mt-md-0">
                    <div class="input-group search-group" style="max-width: 300px;">
                        <input type="text" class="form-control search-input" placeholder="Buscar carrera..." id="tableSearch">
        ...
        <?php if (!empty($carreras)): ?>
            <?php
                ...
                $carreras_paginadas = array_slice($carreras, $inicio, $registros_por_pagina);
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table mb-0" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php foreach ($carreras_paginadas as $carr): ?>
                                <tr>
                                    <td><?= $carr['id'] ?></td>
                                    <td class="font-weight-bold text-dark"><?= esc($carr['nombre']) ?></td>
                                    <td class="text-center">
                                        <a href="<?= base_url("admin/carreras/editar/" . esc($carr['id'])) ?>" 
                    ...
                    <nav aria-label="Navegación de carreras">
                        <ul class="pagination justify-content-end mb-0">
                            ...
                            <?php if ($paginaActual > 1): ?>
                                ...
                                <li class="page-item">
                                    <a class="page-link shadow-none" href="<?= base_url('admin/carreras') . '?' . http_build_query($params) ?>">Anterior</a>
                                </li>
                            <?php else: ?>
                            ...
                            <?php for ($i = 1; $i <= $total_paginas; $i++): ?>
                                ...
                                <li class="page-item <?= ($i == $paginaActual) ? 'active' : '' ?>">
                                    <a class="page-link shadow-none" href="<?= base_url('admin/carreras') . '?' . http_build_query($params) ?>"><?= $i ?></a>
                                </li>
                            <?php endfor; ?>
                            ...
                            <?php if ($paginaActual < $total_paginas): ?>
                                <?php $params['num'] = $paginaActual + 1; ?>
                                <li class="page-item">
                                    <a class="page-link shadow-none" href="<?= base_url('admin/carreras') . '?' . http_build_query($params) ?>">Siguiente</a>
                                </li>
                            <?php else: ?>
        ...
        <?php else: ?>
            <div class="card-body text-center py-5">
                <i class="fas fa-graduation-cap fa-3x text-gray-200 mb-3"></i>
                <p class="text-gray-500">No hay carreras registradas actualmente.</p>
            </div>
        <?php endif; ?>
    </div>
</div>